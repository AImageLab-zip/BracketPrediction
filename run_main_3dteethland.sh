...
python main.py \
    --samples /homes/mlugli/BracketPrediction/Teeth3DS/splits/3DTeethland_debug/testing_lower.txt /homes/mlugli/BracketPrediction/Teeth3DS/splits/3DTeethland_debug/testing_upper.txt \
